...
review. The automatic main database migration passed with its
[deployment receipt](https://github.com/vibies-club/vibies/pull/30#issuecomment-5630665472).
Production runtime verification remains pending. See
[Database deployment](docs/DATABASE-DEPLOYMENT.md) for the rollout steps.
