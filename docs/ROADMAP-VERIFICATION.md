...
Their passing results establish the stated HTTP assertions only.
...
| P8 | A detail page with Milestones shows the ordered Roadmap, each status and Blocked note, a progress bar, and text such as “2 of 3 complete, 67%.” It appears after shared details and before management controls. | [App check run 34898874848](https://github.com/vibies-club/vibies/actions/runs/34898874848/job/104159689184) checks HTML order, a progress element, and `2 of 3 complete, 67%.` Browser confirmation of the visible layout remains pending; see the procedure below. | HTTP checks pass; browser check pending |
...
| P13 | At 20 Milestones, adding is disabled and the page explains the limit. All Roadmap controls work with a keyboard, and status is clear without color alone. | [App check run 34898874848](https://github.com/vibies-club/vibies/actions/runs/34898874848/job/104159689184) checks native-control markup, text states, and the explained disabled Add control at 20. The check named `P13 native roadmap controls support keyboard access and text states do not depend on color` does not exercise keyboard input. Browser operation remains pending; see the procedure below. | HTTP checks pass; browser check pending |
...
1. As an approved owner, open a project with three milestones, two complete.
   Confirm the visible Roadmap follows shared details and precedes management
   controls. Check the progress bar, ordered milestones, state labels, blocked
   note, and “2 of 3 complete, 67%.” text.
2. Use Tab and Shift+Tab to reach each enabled Roadmap control. Use Enter or
   Space as appropriate to add, edit, Save, Cancel, complete, reopen, move up,
   move down, and open and confirm or cancel deletion. Check visible focus and
   the resulting content after each action.
